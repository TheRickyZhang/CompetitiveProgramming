...
#define str string
    int N = 100000; int MOD=2019201997LL; constexpr int INF=1e9; constexpr int INFL=0x3f3f3f3f3f3f3f3f; constexpr auto en = "\n"; constexpr auto sp = " ";
...
int calc(int a, int b) {
    a++, b++;
    if(a > b) swap(a, b);
    return (a * 2019201913 + b * 2019201949) % MOD;
}
