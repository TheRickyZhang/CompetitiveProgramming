...
int main() {
    ...
    // t0=prev type, t1=curr type
    function<void(int, int, int, int)> dfs=[&](int u, int t0, int t1, int val) {
        if(t0==0 && t1==1) val++;
        if(lvl[u]<val) lvl[u]=val;
