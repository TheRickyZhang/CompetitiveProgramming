...
//         int best1 = b.first, best2 = b.second;
//         // Consider candidate from a.first and a.second
//         int cand[2] = {a.first, a.second};
//         for (int i = 0; i < 2; i++) {
//             int cur = cand[i];
//             if (cur > best1) {
//                 if (cur != best1) {
...
//         repr(i, ln-1, 0) {
//             if(x & (1<<i)) continue;
//             auto [a, b] = dp[curr | (1<<i)];
//             if(b > pos) curr |= (1<<i);
//         }
//         // cout<<x<<sp<<curr<<" at "<<pos<<en;
//         ckmx(res, x + curr);
//     }
//     cout<<res<<en;
// }
