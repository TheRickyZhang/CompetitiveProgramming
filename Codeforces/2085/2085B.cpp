...
void solve() {
    ...
    //         if(a[i] == 0) {
    //             cout<<3<<en;
    //             if(a[i+1] != 0) cout<<i<<sp<<i+1<<en;
    //             else cout<<i-1<<sp<<i<<en;
    //
    //         }
    //     }
    //     cout<<3<<en;
    ...
    //     if(a[i] == 0) {
    //         cout<<2<<en;
    //         if(i==0) cout<<1<<sp<<2<<en;
    //         else cout<<i<<sp<<i+1<<en;
    //         cout<<1<<sp<<n-1<<en;
    //         return;
    //     }
    // }
