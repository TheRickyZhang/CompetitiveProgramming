...
int32_t main() {
    ...
    vi res(n, 0);
    f(i, n) {
        // Think about why this is >=. The elements are not the chosen values, but the first value that doesn't work
        // So if a[i+1] <= a[i], then a[i] can't be a breaking value
