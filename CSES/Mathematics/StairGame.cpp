...
void solve() {
    ...
    res ^= (f ? 1 : 0);
    if(res > 0) cout<<"first"<<en;
    else cout<<"second"<<en;
}

// Sprague-Grundy - decompose stair game -> normal nim (take any amount) direct product another num (choose any subset to take 1 from. In this case only subset 2)
int32_t main() {
    setIO();
