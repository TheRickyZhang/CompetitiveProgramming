...
// Naturally, starting from leaf nodes is ideal
// We need to consider which order we traverse in bottom-to-top overall
// Use sz, down, up. Up is the tricky one that considers rest of subtree coontribution, recursion from [v] to [u], and usage of [d] for "detours"
int t, k, n, m;
void solve() {
