...
int k, n, m;
// Please see this, excellent explanation
// https://codeforces.com/blog/entry/68138

// In addition to establishing a dfs tree on any arbitrary graph (decompose to tree + back edges)
// Also provides clever dfs way -> for back edge xy, a[x] -= 1, a[y] += 1;  d[u] = a[u] + sum(d[v]).
//  - Can be considered simpler and more information; d[u] = 0 -> bridge, but can also count number of back edges


// For case of undirected tree, only needs to consider tree edges and back edges
// (no sideways edges because will always be pulled in / discovered by earlier node)
// But *directed* is more difficult, has tree edges, back edges, down edges, and sideways edges
void solve() {
